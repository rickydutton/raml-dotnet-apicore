...
namespace Raml.Common
{
	public class NetNamingMapper
    {
        ...
        public static string GetObjectName(string input)
        {
            ...
            name = ReplaceSpecialChars(name, "{mediaTypeExtension}");
        ...
        protected static bool StartsWithNumber(string name)
        {
        ...
        public static string GetPropertyName(string name, string ns = null)
        {
            var propName = name;
            if (ns != null)
                propName = Regex.Replace(name, $"^{ns}\\.", string.Empty);
